            ...
            <div class="col-lg-10 col-lg-offset-1">
                            ...
                            <div class="widget w-tags">
                                <div class="tags-wrap">
                                    @foreach($post->tags as $tag)
                                        <a href="#" class="w-tag-item">{{$tag->tag}}</a> 
                                    @endforeach
                                </div>
                            </div>
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb">
                        <img src="{{ asset($post->user->profile->avatar) }}" width="60px" height="60px" alt="Author">
                    </div>
...
<!-- 
                            ...
                            <a href="{{ $post->user->profile->linkedin}}" class="social__item" target="_blank">
                                <img src="{{asset('app/svg/youtube.svg')}}" alt="linkedin">
                            </a> -->
